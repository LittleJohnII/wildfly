...
import org.jboss.as.test.integration.web.sso.InvalidationServlet;
...
public class ClusteredSingleSignOnTestCase extends ClusterAbstractTestCase {
    ...
    public void testFormAuthSingleSignOn(
            @ArquillianResource(InvalidationServlet.class) @OperateOnDeployment(DEPLOYMENT_1) URL baseURL1,
            @ArquillianResource(InvalidationServlet.class) @OperateOnDeployment(DEPLOYMENT_2) URL baseURL2) throws Exception {
        log.info("+++ testFormAuthSingleSignOn");
        SSOTestBase.executeFormAuthSingleSignOnTestWithInvalidation(new URL(baseURL1, "/"), new URL(baseURL2, "/"), log);
    }
    ...
    /**
     * Test single sign-on with logout by calling {@link HttpServletRequest#logout()}
     */
    @Test
    public void testLogoutWithClusteredSSO(
        ...
        log.info("+++ testLogoutWithClusteredSSO");
        SSOTestBase.executeFormAuthSingleSignOnTestWithLogout(new URL(baseURL1, "/"), new URL(baseURL2, "/"), log);
    }
